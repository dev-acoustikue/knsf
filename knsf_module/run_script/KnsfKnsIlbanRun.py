...
from KnsfFcm import *
from KnsfParserCaller import KnsfParseKnsIlban
...
# 
# first, read database
db_manager = KnsfKnsDbManagerType1(KNSF_EX_KNS_ILBAN)

# parse necessary information
new_knsf_container = KnsfParseKnsIlban() 
...
if len(updated_list) is not 0: # this means something has been updated.
    ...
    if KNSF_DB_INIT_ILBAN is True:
        ...
        knsf_server.notifyMultipleDevice('일반 공지 업데이트', 
