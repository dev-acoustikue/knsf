...
from KnsfDbManager1 import KnsfKnsDbManagerType2
from KnsfFcm import *
from KnsfParserCaller import KnsfParseKnsJanghak
...
# 
# first, read database
db_manager = KnsfKnsDbManagerType2(KNSF_EX_KNS_JANGHAK)

# parse necessary information
new_knsf_container = KnsfParseKnsJanghak() 
...
if len(updated_list) is not 0: # this means something has been updated.
    ...
    if KNSF_DB_INIT_JANGHAK is True:
        pass
        ...
        knsf_server.notifyMultipleDevice('장학 공지 업데이트', 
                                         KnsfMakeMessageBody(updated_list), 
                                         KNSF_URL_KNS_JANGHAK)
